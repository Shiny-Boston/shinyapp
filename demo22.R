...
crime_repo<-read.csv("tmpttlexpi6.csv") # This is CRIME INCIDENT REPORTS in Boston in 2022. Download from: https://data.boston.gov/dataset/6220d948-eae2-4e4b-8723-2dc8e67722a3/resource/313e56df-6d77-49d2-9c49-ee411f10cf58/download/tmpdg9fc0p7.csv
...
doweek<-as.factor(crime_repo$DAY_OF_WEEK)

doweek<-factor(doweek,levels = levels(factor(1:7,labels = c("Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"))))
